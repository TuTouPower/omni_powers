...
5. **改 tasks_list.json**：用 jq 删原 task 行，加子 task 行（含依赖关系、验收标准、status=待开始）
...
```
拆分完成：
- T09a: 已建目录，spec 切自原 step 1-3，plan 切自原 step 1-3
- T09b: 已建目录，spec 切自原 step 4-5，plan 切自原 step 4-5
- tasks_list.json: 已删 T09，已加 T09a/T09b
```
